...
import com.codeofduty.mdas_rpg.databinding.ActivityEasySubtractionBinding
import com.jakewharton.rxbinding2.widget.RxTextView
import kotlin.random.Random

@SuppressLint("CheckResult")
class EasySubtraction : AppCompatActivity() {
    private lateinit var binding: ActivityEasySubtractionBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityEasySubtractionBinding.inflate(layoutInflater)
    ...
    private fun generateQuestion() {
        // Generate random values between 1 and 10 until firstValue is greater than secondValue
        do {
