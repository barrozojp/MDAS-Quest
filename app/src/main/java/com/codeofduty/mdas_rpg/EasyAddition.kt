...
class EasyAddition : AppCompatActivity() {
    private lateinit var binding: ActivityEasyAdditionBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityEasyAdditionBinding.inflate(layoutInflater)
