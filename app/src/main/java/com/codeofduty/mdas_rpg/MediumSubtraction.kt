...
import com.codeofduty.mdas_rpg.databinding.ActivityMediumSubtractionBinding
import com.jakewharton.rxbinding2.widget.RxTextView
import kotlin.random.Random

@SuppressLint("CheckResult")
class MediumSubtraction : AppCompatActivity() {
    private lateinit var binding: ActivityMediumSubtractionBinding
    ...
    private fun generateQuestion() {
        ...
        do {
            ...
            secondValue = Random.nextInt(1, 51)
