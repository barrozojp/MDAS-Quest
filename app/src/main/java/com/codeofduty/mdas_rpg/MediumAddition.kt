...
import com.codeofduty.mdas_rpg.databinding.ActivityMediumAdditionBinding
import com.jakewharton.rxbinding2.widget.RxTextView
import kotlin.random.Random

@SuppressLint("CheckResult")
class MediumAddition : AppCompatActivity() {
    private lateinit var binding: ActivityMediumAdditionBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMediumAdditionBinding.inflate(layoutInflater)
    ...
    private fun generateQuestion() {
        ...
        firstValue = Random.nextInt(11, 51)
        secondValue = Random.nextInt(11, 51)
