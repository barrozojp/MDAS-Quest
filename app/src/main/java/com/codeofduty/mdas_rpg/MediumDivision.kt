...
import com.codeofduty.mdas_rpg.databinding.ActivityMediumDivisionBinding
import com.jakewharton.rxbinding2.widget.RxTextView
import kotlin.random.Random


@SuppressLint("CheckResult")
class MediumDivision : AppCompatActivity() {
    private lateinit var binding: ActivityMediumDivisionBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMediumDivisionBinding.inflate(layoutInflater)
        setContentView(binding.root)

        databaseHelper = DatabaseHelper(this)
        binding.timer.text = "45"
    ...
    private fun generateQuestion() {
        ...
        // Generate a random first value between 1 and 51 that is divisible by the second value
        firstValue = (1..51).filter { it % secondValue == 0 }.random()
    ...
    private fun restartGame() {
        ...
        binding.etAnswer.text?.clear() // Clear the answer field
        binding.timer.text = "45" // Reset timer display
    ...
    private fun startTimer() {
        timerValue = 45 // Start with 45 seconds
        binding.timer.text = "45"
    ...
    private fun resetTimer() {
        ...
        timerValue = 45 // Reset the timer value to 60 seconds
