...
import com.codeofduty.mdas_rpg.databinding.ActivityHardSubtractionBinding
import com.jakewharton.rxbinding2.widget.RxTextView
import kotlin.random.Random

@SuppressLint("CheckResult")
class HardSubtraction : AppCompatActivity() {
    private lateinit var binding: ActivityHardSubtractionBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityHardSubtractionBinding.inflate(layoutInflater)
    ...
    private fun generateQuestion() {
        ...
        do {
            ...
            secondValue = Random.nextInt(1, 101)
