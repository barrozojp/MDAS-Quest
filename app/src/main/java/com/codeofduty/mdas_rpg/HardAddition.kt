...
import com.codeofduty.mdas_rpg.databinding.ActivityHardAdditionBinding
import com.jakewharton.rxbinding2.widget.RxTextView
import kotlin.random.Random

@SuppressLint("CheckResult")
class HardAddition : AppCompatActivity() {
    private lateinit var binding: ActivityHardAdditionBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityHardAdditionBinding.inflate(layoutInflater)
    ...
    private fun generateQuestion() {
        ...
        firstValue = Random.nextInt(11, 101)
        secondValue = Random.nextInt(11, 101)
